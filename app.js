...
function EntryView({ emp, entries, upsertEntry, certs, certifyPeriod, manualLocks, manualUnlocks, showToast, audit, baseSalary, empAdj, pto, ptoAllowance, ptoStartDate, onRequestPto, onCancelPto }) {
  ...
  }, disabled: periodIdx >= maxPeriodIdx, "aria-label": "Next pay period" }, "\u203A")), /* @__PURE__ */ React.createElement("div", { className: "period-total" }, baseBiweekly > 0 || periodBonus > 0 || periodReimb > 0 || periodStipend > 0 ? /* @__PURE__ */ React.createElement("div", { className: "pay-breakdown" }, baseBiweekly > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, "Base", baseProrated ? " (prorated " + basePr.days + "/" + basePr.of + " weekdays)" : ""), /* @__PURE__ */ React.createElement("span", { className: "pay" }, money(baseBiweekly))), (!noPayTypes || periodDollars > 0) && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, "Variable"), /* @__PURE__ */ React.createElement("span", { className: "pay" }, money(periodDollars))), periodBonus > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, "Bonus"), /* @__PURE__ */ React.createElement("span", { className: "pay" }, money(periodBonus))), periodReimb > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, "Reimbursement"), /* @__PURE__ */ React.createElement("span", { className: "pay" }, money(periodReimb))), periodStipend > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, emp && String(emp.stipendNote || "").trim() || "Stipend"), /* @__PURE__ */ React.createElement("span", { className: "pay" }, money(periodStipend))), /* @__PURE__ */ React.createElement("div", { className: "pay-total" }, /* @__PURE__ */ React.createElement("span", null, "Total"), /* @__PURE__ */ React.createElement("span", { className: "pay" }, money(baseBiweekly + periodDollars + periodBonus + periodReimb + periodStipend)))) : /* @__PURE__ */ React.createElement("span", null, "This period:", /* @__PURE__ */ React.createElement("span", { className: "pay", style: { marginLeft: 6 } }, money(periodDollars))), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--muted)", marginTop: 4 } }, "Payday ", period.paydayLabel))), !noPayTypes && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { height: 12 } }), /* @__PURE__ */ React.createElement("div", { className: "week-grid" }, DOW.map((d) => /* @__PURE__ */ React.createElement("div", { className: "dow", key: "dow-" + d }, d)), periodDays.map((iso) => {
...
function Rates({ employees, salaries, persistEmployees, persistSalaries, showToast }) {
  ...
  ), Number(emp.annualSalary) > 0 && /* @__PURE__ */ React.createElement("div", { className: "fixed-note", style: { marginTop: 4 } }, money(Number(emp.annualSalary) / 26), " per full period \xB7 prorated by weekdays around a start / last day"))), /* @__PURE__ */ React.createElement("div", { className: "field-row" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", null, "PTO days ", /* @__PURE__ */ React.createElement("span", { className: "hint-sm" }, "per calendar year \xB7 resets Jan 1 \xB7 blank = none")), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      inputMode: "decimal",
